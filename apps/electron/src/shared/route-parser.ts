...
import { isValidPolyTab } from './types'
...
export type NavigatorType = 'sessions' | 'sources' | 'skills' | 'automations' | 'settings' | 'poly'
...
const COMPOUND_ROUTE_PREFIXES = [
  'allSessions', 'flagged', 'archived', 'state', 'label', 'view', 'sources', 'skills', 'automations', 'settings', 'poly',
]
...
export function parseCompoundRoute(route: string): ParsedCompoundRoute | null {
  ...
  // SPMA / poly navigator: poly/markets, poly/risk, ...
  if (first === 'poly') {
