...
import type { SessionDraft, DraftAttachmentRef } from '@poly-agents/shared/config'
...
import { TooltipProvider } from '@poly-agents/ui'
...
import { extractWorkspaceSlugFromPath } from '@poly-agents/shared/utils/workspace-slug'
import { DEFAULT_THINKING_LEVEL } from '@poly-agents/shared/agent/thinking-levels'
...
export default function App() {
  ...
  // Platform actions for @poly-agents/ui components (overlays, etc.)
