...
export interface AppShellContextType {
  ...
  getDraftAttachmentRefs: (sessionId: string) => import('@poly-agents/shared/config').DraftAttachmentRef[]
  ...
  labels?: import('@poly-agents/shared/labels').LabelConfig[]
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@poly-agents/core').ContentBadge[]) => void
