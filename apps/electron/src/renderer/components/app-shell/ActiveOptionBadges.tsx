...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@poly-agents/shared/agent/modes'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry } from '@poly-agents/shared/labels'
