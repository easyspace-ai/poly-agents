...
import { DEFAULT_THEME, loadAppTheme } from '@poly-agents/shared/config'
import { getBrowserLiveFxCornerRadii } from '../shared/browser-live-fx'
import type { IBrowserPaneManager } from '@poly-agents/server-core/handlers'
...
export class BrowserPaneManager implements IBrowserPaneManager {
  ...
  // validateUploadFilePath removed — uses shared validateFilePath from @poly-agents/server-core/handlers
