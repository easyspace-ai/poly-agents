...
mock.module('@poly-agents/shared/config', () => ({
...
mock.module('@poly-agents/shared/workspaces', () => ({
  loadWorkspaceConfig: () => ({
    defaults: {
      permissionMode: 'ask',
      thinkingLevel: 'medium',
...
mock.module('@poly-agents/shared/agent', () => ({
...
mock.module('@poly-agents/shared/agent/backend', () => ({
...
mock.module('@poly-agents/shared/sources', () => ({
...
mock.module('@poly-agents/shared/automations', () => ({
...
mock.module('@poly-agents/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@poly-agents/server-core/sessions')
