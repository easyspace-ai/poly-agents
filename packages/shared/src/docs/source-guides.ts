 ...
 * Guides are now served exclusively via the poly-agents-docs MCP server.
 *
 ...
 * Use the poly-agents-docs MCP server to search for setup guides.
 *
 * Example: mcp__poly-agents-docs__SearchPolyAgents({ query: "github source setup guide" })
 */
