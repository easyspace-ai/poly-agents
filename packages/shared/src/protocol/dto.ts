 ...
 * Extracted here so handler code in @poly-agents/server-core can import
 * from @poly-agents/shared/protocol without reaching into the app.
 */
...
export { generateMessageId } from '@poly-agents/core/types'
